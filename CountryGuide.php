...
<div class="wrapper">
  ...
  flex-wrap: wrap;">
                ...
                <div class="input-group mb-3 w-75 input-group-lg">
                    <span class="" style="font-size: 30px;" >Have a nice day!</span>
                </div>
                ...
                <section class="section">
                    ...
                    <div class="GuideImages m-lg-5">
                        <div class=" row ">
                            ...
                            $QryPost = "SELECT User_ID,User_Img, User_FName, User_LName FROM User WHERE User_Nationality='{$CID}' and  Type='1'";
                            ...
                            for ($i = 0; $i < $resultPost->num_rows; $i++) {
                                ...
                                echo'      
  <div class="col-lg-4 mb-5 ml-5" style=" width: 270px;">
  <div class="card" >
    <img src="'.$rowPost[1].'" class="card-img-top " alt="" style="height: 200px; width: 100%;" >
    <div class="card-body">
      <h5 class="card-title"  style="height: 50px; width: 100%;">'.$rowPost[2].' '.$rowPost[3].'</h5>
      <a href="guideprofile.php?Guide_id='.$rowPost[0].'" class="btn btn-primary pro" style="background-color: black; border-color: black">Show Profile</a>
    </div>
  </div>
</div> ';
