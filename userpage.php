...
session_start();
if(isset($_SESSION['AfterLoginAsUser'])){
    if ($_SESSION['AfterLoginAsUser']==1){
        $_SESSION['ForCountry']=1;
...
<div class="wrapper">
  ...
  flex-wrap: wrap;">
            ...
            <!---هون كان في رابر للسيرش حطي مكانها الجايد يلي بتتابعيهم----->
            <div class="story-continer" style="margin-top: 20px;">

                <ul>

                   <?php

                   $_SESSION['ToProfile']=1;

                   $QryStory = "SELECT * FROM follow WHERE Tourist_ID='{$_SESSION['UID']}'";
                   $resultStory = mysqli_query($conn,$QryStory);
                   for ($i = 0; $i < $resultStory->num_rows; $i++) {
                       $rowPost = $resultStory->fetch_object();
                       $storyID = $rowPost-> Guide_ID;
                   $QryStoryImg = "SELECT User_Img, User_FName	FROM User WHERE User_ID='{$storyID}'";
//                   echo "SELECT User_Img FROM User WHERE User_ID='{$storyID}'";
                       $resultStoryImg = mysqli_query($conn,$QryStoryImg);
                       $obImg= $resultStoryImg->fetch_object();

                       echo '
                     <li>
                        <div class ="story">
                            <a href="guideprofile.php?Guide_id='.$storyID.'"" class="dana">
                                <img src="'.$obImg->User_Img.'">
                            </a>
                        </div>
                        <span class="user">'.$obImg->User_FName.'</span>
                    </li>
 ...
 ';}?>
            ...
            <svg baseprofile="tiny" stroke-linecap="round" stroke-linejoin="round"  version="1.2" viewbox="0 0 2000 857"  xmlns="http://www.w3.org/2000/svg">
                ...
                <a xlink:title="Algeria" xlink:href="CountryGuide.php?CID=DZ">
                ...
                <path xlink:title="Algeria" xlink:href="CountryGuide.php?CID=EG"
                        d="M559 502.8l0.8 4.9-1.7 4.1-6.1 6.8-6.7 2.5-3.4 5.6-0.9 4.3-3.1 2.7-2.5-3.3-2.3-0.7-2.3 0.5-0.3-2.3 1.6-1.5-0.7-2.7 2.9-4.8-1.3-2.8-2.1 3-3.5-2.9 1.1-1.8-1-5.8 2-1 1-4 2.1-4.1-0.3-2.6 3.1-1.4 3.9-2.5 5.6 3.6 1.1-0.1 1.4 2.8 4.8 0.9 1.6-1 2.8 2.1 2.4 1.5z" id="EC" name="Ecuador">
                </path>
                ...
                <a xlink:title="Palestine" xlink:href="CountryGuide.php?CID=PS">

                    <path d="M1179.1 288.2l0.4 2.6-0.6 1 0.1 0-0.7 2-2.1-0.8-0.7 4.2 1.5 0.7-1.3 0.9-0.1 1.7 2.5-0.8 0.4 2.5-1.8 10.2-0.7-1.6-3.9-9.4 1.4-2.1-0.4-0.4 1.1-3 0.6-4.8 0.6-1.7 0.1 0 1.8 0 0.4-1.1 1.4-0.1z" id="PS2" name="Palestine">
                    </path></a>
                ...
                <a xlink:title="Palestine" xlink:href="https://www.google.com/search?gs_ssp=eJzj4tTP1TcwzDYoMDFg9OIsSMxJLS7JzEsFAEXcBsg&q=palestine&oq=pales&aqs=chrome.1.69i57j46i131i433i512j0i512l2j0i457i512j0i131i433i512j69i60l2.3165j0j7&sourceid=chrome&ie=UTF-8">
        ...
        <aside class="aside">
            <section class="section">
                ...
                <div class="banner">
                    ...
                    <button  class="banner__button"  data-bs-toggle="modal" data-bs-target=""  >
                        Update my info
                    </button>
                </div>
